...
namespace CXPCXC.Datos
{
    internal sealed class AccesoDatos
    {
        ...
        {
            dbconnection = new SqlConnection(ConfigurationManager.ConnectionStrings["ConectBD"].ConnectionString);
            dbconnection.Open();
        }
        ...
        /// (se usa en conjunto con InsertWithReturnValue)
        /// </summary>
        /// <example>
        /// b.ExecuteCommandSP("Usuario_Contar");               stored procedure
        /// b.AddParameterWithReturnValue("@usuarioscontados"); parámetro de salida    
        /// return b.InsertWithReturnValue();                   retorno del valor procesado en el sp
        /// </example>
        ...
        /// Se usa en conjunto con AddParameterWitReturnValue
        /// </summary>
        /// <seealso cref="AddParameterWithReturnValue"/>
