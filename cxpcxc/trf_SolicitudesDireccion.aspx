<%@ Page Title="" Language="C#" MasterPageFile="~/cxpcxc.Master" AutoEventWireup="true" CodeBehind="trf_SolicitudesDireccion.aspx.cs" Inherits="cxpcxc.trf_SolicitudesDireccion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphAreaTrabajo" runat="server">
    ...
    <fieldset>
        ...
        <asp:Panel ID ="pnContSolicitud"  runat ="server" Width ="100%" Visible ="false" >
            <table style ="width :95%;margin :0 auto ">
                <tr>
                    <td style="font-weight: 700;width:20%" >TOTAL PESOS:</td>
                ...
                <tr>
                    <td colspan ="2" style ="text-align :right"> 
                        <asp:ImageButton ID ="btnExportar" runat ="server" ImageUrl ="~/img/ExpExcel.png" OnClick="btnExporta_Click"  />
                    </td>
                </tr>
            </table>
            <asp:Panel ID ="pnSolicitud"  runat ="server" Width ="100%" Height ="450px" ScrollBars ="Auto">
