<%@ Page Title="" Language="C#" MasterPageFile="~/cxpcxc.Master" AutoEventWireup="true" CodeBehind="cxc_AltaOrdenServicio.aspx.cs" Inherits="cxpcxc.cxc_AltaOrdenServicio" enableEventValidation="false"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphAreaTrabajo" runat="server">
    ...
    <fieldset >
        ...
        <div id="dvSelCliente" runat ="server" style ="width :100%" >
            <table id ="tblSelCliente" runat ="server" style =" width :80%;margin :0 auto" >
                <tr>
                    ...
                    <td><asp:DropDownList ID ="dpCliente" runat ="server" AutoPostBack ="true" OnSelectedIndexChanged="dpCliente_SelectedIndexChanged" CausesValidation ="false"  ></asp:DropDownList>
                        ...
                        <table id ="tblDatos" runat ="server" style ="width :100%;" >
                            <tr>
                                ...
                                <td>
                                    ...
                                    <ajaxtoolkit:calendarextender ID="ce_txFhInicio" runat="server" TargetControlID="txFhInicio" PopupButtonID="ImgCalInicio" Format="dd/MM/yyyy" ></ajaxtoolkit:calendarextender>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Panel ID="pnMonto" runat="server">
                                        <asp:TextBox ID="txMonto" runat ="server" Text ="0"></asp:TextBox>
                            ...
                            <tr>
                                <td style ="text-align:right"><b>Empresa facturación:</b></td>
                                <td style="width:5px" ></td>
                                <td colspan ="3"><asp:DropDownList ID ="dpEmpresa" runat ="server" ></asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="rfvEmpresa" runat="server" ControlToValidate="dpEmpresa" ErrorMessage="*"  ForeColor="Red" InitialValue="0" ValidationGroup="Orden"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
        ...
        <ajaxToolkit:CascadingDropDown 
            ID="cddwEmpresa" runat="server" 
            TargetControlID="dpEmpresa" 
            PromptText="Seleccionar" 
            LoadingText="[Cargando...]" 
            ServiceMethod="xDatos"/>
        <ajaxToolkit:CascadingDropDown 
            ID="cddCondicionpago" runat="server" 
            TargetControlID="dpCodPago" 
            Category="CdPago"
            PromptText="Seleccionar" 
            LoadingText="[Cargando...]" 
            ServiceMethod="xDatos"
            ParentControlID="dpEmpresa"/>
        <ajaxToolkit:CascadingDropDown 
            ID="cddProyectos" runat="server" 
            TargetControlID="dpProyecto" 
            Category="Proyecto"
            PromptText="Seleccionar" 
            LoadingText="[Cargando...]" 
            ServiceMethod="xDatos"
            ParentControlID="dpEmpresa"/>
        <ajaxToolkit:CascadingDropDown 
            ID="ccdServicios" runat="server" 
            TargetControlID="dpServicio" 
            Category="Servicio"
            PromptText="Seleccionar" 
            LoadingText="[Cargando...]" 
            ServiceMethod="xDatos"
