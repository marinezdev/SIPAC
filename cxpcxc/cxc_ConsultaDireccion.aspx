<%@ Page Title="" Language="C#" MasterPageFile="~/cxpcxc.Master" AutoEventWireup="true" CodeBehind="cxc_ConsultaDireccion.aspx.cs" Inherits="cxpcxc.cxc_ConsultaDireccion"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphAreaTrabajo" runat="server">
    ...
    <fieldset>
        ...
        <asp:Panel ID ="pnOrdFact" runat ="server" Height ="450px"  ScrollBars="Vertical">
            <asp:Repeater ID="rptOrdFact" runat="server" OnItemDataBound="rptOrdFact_ItemDataBound" OnItemCommand="rptOrdFact_ItemCommand" >
                <HeaderTemplate>
