<%@ Page Title="" Language="C#" MasterPageFile="~/cxpcxc.Master" AutoEventWireup="true" CodeBehind="admClientesEmpresas.aspx.cs" Inherits="cxpcxc.admClientesEmpresas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphAreaTrabajo" runat="server">
    ...
    <fieldset>
        <legend>ASIGNAR CLIENTES A EMPRESAS</legend>
        ...
        <asp:Panel ID ="pnEmpresasClientes"  runat ="server" Width="100%">
            <asp:Repeater ID="rptEmpresasClientes" runat="serveR" OnItemCommand="rptEmpresasClientes_ItemCommand" >
                <HeaderTemplate>
                    <table id="tblEmpresasClientes" border="1" style ="width :100%"  class="tblFiltrar" >
                        <thead>
                ...
                <ItemTemplate>
                    <tr style="background-color: White; color: #333333">
                        ...
                        <td style="width :250px"><%# Eval("nombrecliente")%></td>
                        <td style="width: 50px; text-align: center"><%# Eval("activo").ToString() == "True" ? "Activo" : "Inactivo"%></td>
                        <td style="text-align:center; width:80px">
                            <asp:ImageButton ID="imgbtnEditar"  runat ="server"  ImageUrl="~/img/edit.png" CommandName="Editar" CommandArgument='<%# Eval("Idempresa") +","+ Eval("idcliente")%>'  CausesValidation="false"  ToolTip ="Editar"/>
                        </td>
                    </tr>
                </ItemTemplate>
