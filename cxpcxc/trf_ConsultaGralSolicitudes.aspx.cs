...
namespace cxpcxc
{
    public partial class trf_ConsultaGralSolicitudes : Utilerias.Comun
    {
        ...
        private void EjecutaConsulta(string Consulta)
        {
            ...
            if (!string.IsNullOrEmpty(Consulta))
            {
                ...
                List<cpplib.Solicitud> Lista = comun.admsolicitud.DaSolXEmpresa(Convert.ToInt32(hdIdEmpresa.Value), Consulta);
                if (Lista.Count > 0)
                {
        ...
        protected void rptSolicitud_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("trf_VerSolicitud.aspx?id=" + e.CommandArgument.ToString() + "&bk=trf_ConsultaGralSolicitudes"); 
            }
        }
