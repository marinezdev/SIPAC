...
namespace cxpcxc
{
    public partial class cxc_ConsultaOrdServicioModificar : Utilerias.Comun
    {
        ...
        private string Daconsulta()
        {
            ...
            //resultado = ArmaConsulta(resultado, (" Estado=" + cpplib.OrdenServicio.EstadoOrdSvc.Abierto.ToString("d")));
            ...
            resultado += " and  Estado=" + cpplib.OrdenServicio.EstadoOrdSvc.Abierto.ToString("d");
        ...
        {
            if (e.CommandName == "VerDat") {Response.Redirect("cxc_OrdenServicioModificar.aspx?ord=" + e.CommandArgument.ToString());
            }
        ...
        private void DecargarContrato(int IdServicio)
        {
            ...
            cpplib.ArchivoContrato oAr = (new cpplib.admArchivosContrato()).carga(IdServicio);
        ...
        private void AgregaConsultaSesion(string Datos)
        {
            ...
            csConsulta.Pagina = "cxc_ConsultaOrdServicioModificar";
        ...
        private void ValidaConsultaPrevia()
        {
            if (Session["csConsultas"] != null)
            {
                ...
                if (csConsulta.Pagina.Equals("cxc_ConsultaOrdServicioModificar"))
                {
