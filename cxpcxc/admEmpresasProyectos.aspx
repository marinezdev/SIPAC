<%@ Page Title="" Language="C#" MasterPageFile="~/cxpcxc.Master" AutoEventWireup="true" CodeBehind="admEmpresasProyectos.aspx.cs" Inherits="cxpcxc.admEmpresasProyectos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphAreaTrabajo" runat="server">
    ...
    <fieldset>
        <legend>ASIGNAR PROYECTOS A EMPRESAS</legend>
        ...
        <asp:Panel ID ="pnEmpresasProyectos"  runat ="server" Width="100%">
            <asp:Repeater ID="rptEmpresasProyectos" runat="serveR" OnItemCommand="rptEmpresasProyectos_ItemCommand" >
                <HeaderTemplate>
                    <table id="tblEmpresasProyectos" border="1" style ="width :100%"  class="tblFiltrar" >
                        <thead>
                ...
                <ItemTemplate>
                    <tr style="background-color: White; color: #333333">
                        ...
                        <td style="width :250px"><%# Eval("tituloproyecto")%></td>
                        <td style="width: 50px; text-align: center"><%# Eval("activo").ToString() == "True" ? "Activo" : "Inactivo"%></td>
                        <td style="text-align:center; width:80px">
                            <asp:ImageButton ID="imgbtnEditar"  runat ="server"  ImageUrl="~/img/edit.png" CommandName="Editar" CommandArgument='<%# Eval("Idempresa") +","+ Eval("idproyecto")%>'  CausesValidation="false"  ToolTip ="Editar"/>
                        </td>
                    </tr>
                </ItemTemplate>
    ...
    <asp:HiddenField ID ="hdIdProy" runat ="server" />
</asp:Content>
