<%@ Page Title="" Language="C#" MasterPageFile="~/cxpcxc.Master" AutoEventWireup="true" CodeBehind="cxc_ConsultaOrdServicio.aspx.cs" Inherits="cxpcxc.cxc_ConsultaOrdServicio" %>
    ...
    <fieldset>
        ...
        <asp:Panel ID ="pnConsulta" runat="server">
            <table id ="tbConsulta" runat ="server" style ="width:80%;margin:0 auto " class ="tblConsulta" >
                ...
                <tr>
                    <td colspan ="2">
                        <asp:CheckBox ID ="chkActivos" runat ="server" Checked ="true" Text ="Mostrar solo ordenes activas" />
                    </td>
                </tr>
                <tr>
                ...
                <ItemTemplate>
                    <tr style="background-color: White; color: #333333">
                        ...
                        <td style="text-align: center;width :50px">
                            <asp:ImageButton ID="imgbtnverDat" runat="server" ImageUrl="~/img/Folder_A.png" CommandName="VerDat" CommandArgument='<%# Eval("IdServicio")%>' ToolTip ="Ver partidas" />
                        </td>
                    </tr>
                </ItemTemplate>
