...
namespace cxpcxc
{
    public partial class trf_AltaSolRecibo: Utilerias.Comun
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            { 
                ...
                this.ce_FhRecibo.StartDate = DateTime.Now;
                this.ce_FhRecibo.EndDate = DateTime.Now.AddDays(30);
                this.llenaProveedor();
                this.llenaCatalogos(); 
            }
        }
        ...
        private void llenaProveedor()
        {
            ...
            cpplib.CatProveedor opvd = comun.admcatproveedor.carga(Idpv);
        ...
        private cpplib.Solicitud recuperaDatos(cpplib.credencial oCredencial)
        {
            ...
            if (chkReporteIva.Checked) { oSol.ReporteIva = 1; } else { oSol.ReporteIva = 0; }
            return oSol;
        }
