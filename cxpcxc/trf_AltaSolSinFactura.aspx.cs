...
namespace cxpcxc
{
    public partial class trf_AltaSolSinFactura : Utilerias.Comun
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack) 
            {
                ...
                this.ce_FhFactura.StartDate = DateTime.Now;
                this.ce_FhFactura.EndDate = DateTime.Now.AddDays(30);
        ...
        {
            cpplib.CatProveedor opvd = comun.admcatproveedor.carga(Idpvd);
