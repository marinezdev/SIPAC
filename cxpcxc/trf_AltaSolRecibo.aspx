<%@ Page Title="" Language="C#" MasterPageFile="~/cxpcxc.Master" AutoEventWireup="true" CodeBehind="trf_AltaSolRecibo.aspx.cs" Inherits="cxpcxc.trf_AltaSolRecibo" %>
            ...
            <table id ="tblSol" runat ="server" style ="width:90%; margin :0 auto">
                ...
                <tr>
                    <td colspan ="4" style ="height :50px">
                        <b><asp:CheckBox ID ="chkReporteIva" runat ="server"  Text ="Reportar IVA" ForeColor="Green" Font-Size="14px"/></b>
                    </td>
                </tr>
            </table><br />
