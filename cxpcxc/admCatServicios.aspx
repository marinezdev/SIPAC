<%@ Page Title="" Language="C#" MasterPageFile="~/cxpcxc.Master" AutoEventWireup="true" CodeBehind="admCatServicios.aspx.cs" Inherits="cxpcxc.admCatServicios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphAreaTrabajo" runat="server">
    ...
    <fieldset>
        <legend>CATALOGO DE SERVICIOS</legend>
        ...
        <div id="dvCampos" runat ="server"  style ="width:100%">
            <table id="tblCampos" runat ="server" style="width:85%; text-align:left; margin:0 auto;" >
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txServicio" runat ="server"  MaxLength ="80" Width ="90%"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvServicio" runat="server" ControlToValidate="txServicio" ErrorMessage="*"  ForeColor="Red"></asp:RequiredFieldValidator>
                        <ajaxToolkit:FilteredTextBoxExtender ID="fteServicio" runat="server" TargetControlID="txServicio" FilterMode="ValidChars" ValidChars="ABCDEFGHIJKLMNÑOPQRSTUVWXYZabcdefghijklmnñopqrstuvwxyz 0123456789áéíóúÁÉÍÓÚ.," />
                    </td>
                </tr>
        ...
        <asp:Panel ID ="pnServicios"  runat ="server" Width ="100%">
            <asp:Repeater ID="rptServicios" runat="serveR" OnItemCommand="rptServicios_ItemCommand" >
                <HeaderTemplate>
                    <table id="tblServicios" border="1" style ="width :80%"  class="tblFiltrar" >
                        <thead>
