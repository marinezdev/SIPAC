<%@ Page Title="" Language="C#" MasterPageFile="~/cxpcxc.Master" AutoEventWireup="true" CodeBehind="admCatProyectos.aspx.cs" Inherits="cxpcxc.admCatProyectos"    %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphAreaTrabajo" runat="server">
    ...
    <fieldset>
        <legend>CATALOGO DE PROYECTOS</legend>
        ...
        <div id="dvCampos" runat ="server"  style ="width:100%">
            <table id="tblCampos" runat ="server" style="width:85%; text-align:left; margin:0 auto;" >
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txProyecto" runat ="server"  MaxLength ="80" Width ="90%"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvProyecto" runat="server" ControlToValidate="txProyecto" ErrorMessage="*"  ForeColor="Red"></asp:RequiredFieldValidator>
                        <ajaxToolkit:FilteredTextBoxExtender ID="fteProyecto" runat="server" TargetControlID="txProyecto" FilterMode="ValidChars" ValidChars="ABCDEFGHIJKLMNÑOPQRSTUVWXYZabcdefghijklmnñopqrstuvwxyz 0123456789áéíóúÁÉÍÓÚ.," />
                    </td>
                </tr>
        ...
        <asp:Panel ID ="pnProy"  runat ="server" Width ="100%">
            <asp:Repeater ID="rptProy" runat="serveR" OnItemCommand="rptProy_ItemCommand" >
                <HeaderTemplate>
                    <table id="tblProy" border="1" style ="width :80%"  class="tblFiltrar" >
                        <thead>
