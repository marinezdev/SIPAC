...
namespace cxpcxc
{
    public partial class cxc_PendientesCobro : Utilerias.Comun
    {
        ...
        private void ListaOrdenfactura()
        {
            ...
            if (Lista.Rows.Count > 0)
            {
                ...
                //rptOrdFact.DataBind();
                LlenarControles.LLenarRepeaterDataTable(ref rptOrdFact, Lista);
        ...
        private string Daconsulta()
        {
            ...
            resultado = ArmaConsulta(resultado, (" F.IdEmpresa=" + hdIdEmpresa.Value));
