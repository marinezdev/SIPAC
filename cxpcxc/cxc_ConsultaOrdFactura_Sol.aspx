<%@ Page Title="" Language="C#" MasterPageFile="~/cxpcxc.Master" AutoEventWireup="true" CodeBehind="cxc_ConsultaOrdFactura_Sol.aspx.cs" Inherits="cxpcxc.cxc_ConsultaOrdFactura_Sol" %>
            ...
            <asp:Repeater ID="rptOrdFact" runat="server" OnItemCommand="rptsol_ItemCommand" OnItemDataBound="rptOrdFact_ItemDataBound" >
                ...
                <ItemTemplate>
                    <tr style="background-color: White; color: #333333">
                        ...
                        <td style="text-align: center; width: 40px">
                            <asp:ImageButton ID="imgbtnMail" runat="server" ImageUrl="~/img/email_gr.png" CommandName="Mail" CommandArgument='<%# Eval("IdOrdenFactura")%>' Enabled ="false"  ToolTip ="Enviar factura Cliente" OnClientClick="return ConfirmaEnvioCorreo();" />
                        </td>
                    </tr>
                </ItemTemplate>
