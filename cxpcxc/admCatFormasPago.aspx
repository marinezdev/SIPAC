<%@ Page Title="" Language="C#" MasterPageFile="~/cxpcxc.Master" AutoEventWireup="true" CodeBehind="admCatFormasPago.aspx.cs" Inherits="cxpcxc.admCatFormasPago" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphAreaTrabajo" runat="server">
    ...
    <fieldset>
        <legend>CATALOGO DE FORMAS DE PAGO</legend>
        ...
        <div id="dvCatCodPago" runat ="server"  style ="width:100%">
            <table id="tblCampos" runat ="server" style="width:85%; text-align:left; margin:0 auto;" >
                <tr>
                    <td style="width:25%;">FORMAS DE PAGO:</td>
                    <td>
        ...
        <asp:Panel ID ="pnfrmsPago"  runat ="server" Width ="100%">
            <asp:Repeater ID="rptfrmsPago" runat="serveR" OnItemCommand="rptCodPago_ItemCommand"  >
                <HeaderTemplate>
                    <table id="tblfrmsPago" border="1" style ="width :80%;"  class="tblFiltrar" >
                        <thead>
