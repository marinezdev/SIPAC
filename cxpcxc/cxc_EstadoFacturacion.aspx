<%@ Page Title="" Language="C#" MasterPageFile="~/cxpcxc.Master" AutoEventWireup="true" CodeBehind="cxc_EstadoFacturacion.aspx.cs" Inherits="cxpcxc.cxc_EstadoFacturacion" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphAreaTrabajo" runat="server">
    ...
    <fieldset>
        <legend>CONSULTAR ORDEN FACTURACION</legend>
        ...
        <asp:Panel  ID ="pnToales" runat ="server"  >
            <table id ="tblTotales" runat ="server" style ="width:100%">
                <tr>
                    <td style ="width :50%"><b>TOTAL COBRADO:</b>
                        <asp:Label ID ="lbCobrado" runat ="server" ></asp:Label>
                    </td>                    
                    <td><b>TOTAL POR COBRAR:</b>
                        <asp:Label ID ="lbXCobrar" runat ="server" ></asp:Label>
                    </td>
                </tr>
            </table>
        </asp:Panel><br />
        <asp:Panel ID ="pnOrdFact" runat ="server" Height ="450px"  ScrollBars="Vertical">
                    ...
                    <tr style="background-color: White; color: #333333">
                       ...
                       <td style="text-align: center; width: 40px">
                        ...
                        <td style="text-align: center; width: 40px">
                            ...
                            <asp:ImageButton ID="imgbtnNota" runat="server" ImageUrl="~/img/Nota.png" CommandName="VerNota" CommandArgument='<%# Eval("IdOrdenFactura")%>'  ToolTip ="Ver Anotacion" Visible="false"  OnClick="imgbtnNota_Click" />
                        </td>
                    </tr>
                </ItemTemplate>
         ...
         <asp:Panel  ID ="pnPopDocumento" runat ="server" Width ="800px" Style="display:none; background-color: #F2F2F2;"   >
            ...
            <asp:Panel ID="pnlDocumento" runat ="server" Width="100%" Height="530px" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" >
        ...
        <asp:Panel  ID ="pnPopNota" runat ="server" Width ="450px" Style="display:none; background-color: #F2F2F2;"   >
            <fieldset>
                <legend >NOTA</legend>
                <asp:Panel ID="pnNota" runat ="server" Width="100%" Height="250px" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" >
                     <div id="dvNota" style="width: 100%; text-align: right;">
                        <asp:Button ID="btnCierraNota" runat="server" CssClass="button" Text="Cerrar" CausesValidation="False" />
                    </div>
                    <asp:Literal ID="ltNota" runat="server" ></asp:Literal>
                </asp:Panel>
            </fieldset>
        </asp:Panel>
                
        <ajaxToolkit:ModalPopupExtender ID="mpeNota" runat="server"
            BackgroundCssClass="modalBackground"
            DropShadow="true"
            BehaviorID="mpeNota"
            TargetControlID="btnmpeNota"
            PopupControlID="pnPopNota"
            OkControlID ="btnCierraNota">
        </ajaxToolkit:ModalPopupExtender>
        <asp:Button ID="btnmpeNota" runat="server" CausesValidation="False" Style="display:none" /> 
