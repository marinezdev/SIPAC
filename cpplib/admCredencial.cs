...
namespace cpplib
{
    public class admCredencial
    {
        ...
        /// <summary>
        /// Valida si el usuario existe en el sistema, así como su contraseña y si su estado es válido
        /// Modificado 17/09/20
        /// Agregado cifrado de la clave para compararla con la BD
        /// </summary>
        /// <param name="pUsuario"></param>
        /// <param name="pClave"></param>
        /// <returns></returns>
        public bool usuarioClaveCorrecto(string pUsuario, string pClave)
        {
            ...
            string enc = Seguridad.Cifrado.Encriptar(pClave);
            string consulta = "exec Administracion_Usuarios_Seleccionar_Validar " + pUsuario + ",'" + enc.Replace("\"","") + "'";
            mbd.BD BD = new mbd.BD();
            DataTable datos = BD.LeeDatos(consulta);
        ...
        private credencial arma(DataRow pRegistro)
        {
            ...
            if (!pRegistro.IsNull("IdEmpresa")) { resultado.IdEmpresaTrabajo = Convert.ToInt32(pRegistro["IdEmpresa"]); }
            return resultado;
        }
        ...
        /// Modificado 17/09/20
        /// Se agrega la clave para validar el usuario
        /// </summary>
        /// <param name="pUsuario"></param>
        /// <param name="pClave"></param>
        /// <returns></returns>
        public credencial carga(string pUsuario, string pClave)
        {
            ...
            string enc = Seguridad.Cifrado.Encriptar(pClave);
            string consulta = "exec Administracion_Usuarios_Seleccionar_Detalle " + pUsuario + ",'" + enc.Replace("\"","") + "'";
            mbd.BD BD = new mbd.BD();
            DataTable datos = BD.LeeDatos(consulta);
            if (datos.Rows.Count > 0) 
            { 
        ...
        /// <summary>
        /// Modifica la clave y contraseña del usuario
        /// Modificado 18/09/20 para cifrar la contraseña del usuario
        /// Se agrega encriptado para codificar la contraseña
        /// </summary>
        /// <param name="pIdUsr"></param>
        /// <param name="pUsuario"></param>
        /// <param name="pClave"></param>
        public void modificaClave(int pIdUsr, String pUsuario, String pClave)
        {
            ...
            string consulta = "Administracion_Usuarios_Modificar_Clave " + pIdUsr + ",'" + pUsuario + "','" + Seguridad.Cifrado.Encriptar(pClave) + "'";
            mbd.BD BD = new mbd.BD();
        ...
        public List<credencial> DaUsuariosPresidencia()
        {
            List<credencial> resultado = new List<credencial>();
        ...
        public DataTable DalistaEmpresaAsignadasUsuario(int pIdUsr)
        {
            String SqlCmd = "select E.Id,E.Nombre from cat_AccesoEmpresas as C left join cat_Empresas as E";
            SqlCmd += " on E.Id=C.IdEmpresa";
            SqlCmd += " where IdUsuario=" + pIdUsr.ToString();
            mbd.BD BD = new mbd.BD();
            DataTable Resultado= BD.LeeDatos(SqlCmd);
            BD.CierraBD();
            return Resultado;
        }
    }
    ...
    public class credencial
    {
        ...
        public int IdEmpresaTrabajo { get; set; }

        public enum usrEstado { Desactivado = 0, Activo = 1 }
        public enum usrGrupo 
        {
            systemall = 101
            , Admsys = 100
            , Administrador = 70
